...
const ProjectItem = ({ image, title, website, details }) => {
	return (
		<div className=" relative flex items-center justify-center h-auto w-full shadow-md shadow-pink-500 rounded-xl group hover:bg-gradient-to-r from-pink-50 to-pink-300 ">
			<img
				src={image}
				alt={title}
			...
			<div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
				...
				<p className=" text-stone-600 pb-4 text-sm pt-2 text-center">
					{details}
				</p>
				<a
					href={website}
